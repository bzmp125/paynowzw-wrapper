...
class Topup extends main{
    ...
    function initialise_transaction(){
        /*
         * This is where you might want to do anything user specific like grabbing the username or id or whatever
        ...
        $paynow_data['returnurl'] = "absolute_url"; //this is where the user will be redirected to once payment has been completed
        $paynow_data['resulturl'] = "absolute_url"; //this is the url Paynow will be 'POSTing' updates to. you should structure it
                                                    //such that your system should know what to do with the parameters passed.
        ...
        if($paynow_return['status']=="Ok" && $hash_to_check==$paynow_return['hash']){
            ...
            $return['data']= ["browserurl"=>$paynow_return['browserurl']]; //this is the url you should now redirect your user to
        }else{
